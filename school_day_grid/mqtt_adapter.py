...
def publish_discovery_and_state(settings: Settings, schedule: ScheduleService) -> None:
    ...
    client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION2, client_id="school-day-grid")
    ...
    try:
        device = {
            "identifiers": ["school_day_grid"],
            "name": "School Day Grid",
            "manufacturer": "School Day Grid",
        ...
        for key, payload in entities.items():
            ...
            object_id = f"school_day_grid_{key}"
