"""SQLite persistence for the standalone School Day Grid product."""
...
class Database:
    ...
    @staticmethod
    def hash_password(password): return hashlib.sha256(("school-day-grid:"+password).encode()).hexdigest()
