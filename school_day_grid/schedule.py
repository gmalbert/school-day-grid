...
class ScheduleService:
    ...
    def to_ics(self,profile="school",include_no_school=True,include_weekends=False)->bytes:
        p=self._profile(profile); cal=Calendar(); cal.add("prodid","-//School Day Grid//Standalone Calendar//EN"); cal.add("version","2.0"); cal.add("calscale","GREGORIAN"); cal.add("x-wr-calname",p["name"])
